...
class Sale extends Component {
        ...
        if (goto2[0] === 'true') {
          getPending2(bookIDs1, title1, function () {
            getTradePartnerID2(tradePartnerIDs, bookIDs1[0], function () {
              console.log("FIRST: " + tradePartnerIDs[0])
          ...
          getTradePartnerID(tradePartnerIDs, bookIDs1[0], function () {
            console.log("SECOND: " + tradePartnerIDs[0])
            if (!tradePartnerIDs[0]) {
              if (!alert("You do not have a current sale!")) {
                window.location.href = "/home"
              }
  ...
  renderAcceptButton() {
    return <Button onClick={(e) => { confirmSale(document.getElementById("user2").innerHTML, document.getElementById("book1").innerHTML, document.getElementById("book2").innerHTML); }}>Accept Sale</Button>
  }
  renderCancelButton() {
    return <Button onClick={(e) => { removePendingOneWay(document.getElementById("user2").innerHTML, document.getElementById("book1").innerHTML, document.getElementById("book2").innerHTML); }}>Cancel Sale</Button>
  }
  renderHomeButton() {
